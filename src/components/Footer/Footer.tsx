...
const Footer = () => {
  return (
    <footer className="flexCenter pb-5 blue-background">
      <div className="padding-container flex pt-10 w-full  px-10 flex-col gap-10">
        <div className="flex flex-col items-start justify-center gap-10 md:flex-row">
          ...
          />
            ...
            <p className="text-white">
              <b>CoverUp Insurance</b> offers comprehensive insurance solutions to protect what matters most. Located in the heart of Johannesburg, we are dedicated to providing personalized service and peace of mind.
            </p>
          </div>
